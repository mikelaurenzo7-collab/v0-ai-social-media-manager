...
const SEED_AUTOMATIONS: Automation[] = [
  {
    ...
    agentId: 'linkedin',
    agentAvatar: 'in',
    agentColor: 'linear-gradient(135deg, #0A66C2 0%, #084E96 100%)',
    platform: 'linkedin',
  ...
  },
  {
    ...
    agentId: 'tiktok',
    agentAvatar: 'TT',
    agentColor: 'linear-gradient(135deg, #25F4EE 0%, #000000 50%, #FE2C55 100%)',
    platform: 'tiktok',
    schedule: 'Mon, Wed, Fri · 5:00 PM',
    topic: 'hooks, productivity, mindset shifts',
    active: true,
    postsPublished: 28,
  ...
  },
  {
    ...
    agentId: 'twitter',
    agentAvatar: 'X',
    agentColor: 'linear-gradient(135deg, #000000 0%, #1F2937 100%)',
    platform: 'twitter',
  ...
  },
  {
    ...
    agentId: 'instagram',
    agentAvatar: 'IG',
    agentColor: 'linear-gradient(135deg, #833AB4 0%, #FD1D1D 50%, #FCB045 100%)',
    platform: 'instagram',
...
const FEED_POOL: Omit<FeedItem, 'id' | 'ts'>[] = [
  ...
  { type: 'published',  agent: 'Instagram Agent', message: 'Published to Instagram · "The real reason your engagement is dropping"', platform: 'instagram' },
  ...
  { type: 'success',    agent: 'Instagram Agent', message: 'Instagram caption optimized · Engagement score: 8.1/10',                platform: 'instagram' },
  ...
  { type: 'analyzing',  agent: 'TikTok Agent',    message: 'Running performance analysis on scheduled TikTok content…',             platform: 'tiktok' },
  { type: 'scheduled',  agent: 'Instagram Agent', message: 'Scheduled Instagram post · This Friday 6:00 PM (peak window)',          platform: 'instagram' },
  { type: 'generating', agent: 'X Agent',         message: 'Adapting top LinkedIn post for X thread format…',                       platform: 'twitter' },
  { type: 'published',  agent: 'TikTok Agent',    message: 'Published to TikTok · Reached 8,400 in first 2 hours',                  platform: 'tiktok' },
]

const AGENT_STATUS = [
  { id: 'tiktok',    name: 'TikTok Agent',    avatar: 'TT', color: 'linear-gradient(135deg, #25F4EE 0%, #000000 50%, #FE2C55 100%)', status: 'active', lastRan: '45 min ago', nextRun: 'Today 5:00 PM',    postsWeek: 6 },
  { id: 'linkedin',  name: 'LinkedIn Agent',  avatar: 'in', color: 'linear-gradient(135deg, #0A66C2 0%, #084E96 100%)',              status: 'active', lastRan: '2 hrs ago',  nextRun: 'Tomorrow 8:30 AM', postsWeek: 5 },
  { id: 'instagram', name: 'Instagram Agent', avatar: 'IG', color: 'linear-gradient(135deg, #833AB4 0%, #FD1D1D 50%, #FCB045 100%)', status: 'active', lastRan: '3 hrs ago',  nextRun: 'Today 12:00 PM',   postsWeek: 7 },
  { id: 'twitter',   name: 'X Agent',         avatar: 'X',  color: 'linear-gradient(135deg, #000000 0%, #1F2937 100%)',              status: 'idle',   lastRan: '6 days ago', nextRun: 'Sunday 10:00 AM',  postsWeek: 1 },
]
...
function CreateAutomationModal({ onClose, onCreated }: { onClose: () => void; onCreated: (a: Automation) => void }) {
  ...
  const agentOptions = [
    { id: 'twitter',   name: 'X Agent',         avatar: 'X',  desc: 'X (Twitter) integration',   color: 'linear-gradient(135deg, #000000 0%, #1F2937 100%)' },
    { id: 'instagram', name: 'Instagram Agent', avatar: 'IG', desc: 'Instagram integration',     color: 'linear-gradient(135deg, #833AB4 0%, #FD1D1D 50%, #FCB045 100%)' },
    { id: 'linkedin',  name: 'LinkedIn Agent',  avatar: 'in', desc: 'LinkedIn integration',      color: 'linear-gradient(135deg, #0A66C2 0%, #084E96 100%)' },
    { id: 'facebook',  name: 'Facebook Agent',  avatar: 'f',  desc: 'Facebook integration',      color: 'linear-gradient(135deg, #1877F2 0%, #0B5FCF 100%)' },
    { id: 'tiktok',    name: 'TikTok Agent',    avatar: 'TT', desc: 'TikTok integration',        color: 'linear-gradient(135deg, #25F4EE 0%, #000000 50%, #FE2C55 100%)' },
  ]
            ...
            >
              ...
              <div className="relative">
                ...
                <p className="text-[11px] text-white/60 mb-3 leading-relaxed">
                  Open any platform agent to fine-tune topics, posting cadence, and content rules.
                </p>
                <Link href="/dashboard/agents" className="inline-flex items-center gap-1.5 text-xs font-bold" style={{ color: '#FB923C' }}>
                  Manage agents →
                </Link>
              </div>
            </div>
