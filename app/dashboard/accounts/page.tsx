...
const platforms = [
  ...
  },
  {
    id: 'tiktok',
    name: 'TikTok',
    description: 'Publish video scripts and captions to TikTok',
    icon: (
      <svg className="h-8 w-8" viewBox="0 0 24 24" fill="currentColor">
  ...
  },
  {
    id: 'linkedin',
    name: 'LinkedIn',
    description: 'Share thought leadership content on LinkedIn',
    icon: (
      <svg className="h-8 w-8" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className="p-6 space-y-6">
        ...
        <Card className="border-primary/20 bg-primary/5">
          <CardContent className="flex items-start gap-4 py-4">
            ...
            <div>
              <h3 className="font-medium">Direct posting coming soon!</h3>
            ...
            <Card key={platform.id} className="relative overflow-hidden">
              <CardHeader>
                <div className="flex items-start justify-between">
                  <div className={`flex h-14 w-14 items-center justify-center rounded-xl ${platform.bgColor} text-white`}>
                    {platform.icon}
                  </div>
          ...
          <CardContent>
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm">Click connect and authorize PostPilot to access your account</span>
              </li>
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm">Create content using AI and select which accounts to post to</span>
              </li>
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm">Post instantly or schedule for the perfect time</span>
              </li>
            </ul>
          </CardContent>
        </Card>
